...
const sections = [
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p className="text-muted-foreground">
          Please note that Princeton Professional does not offer a 100% refund under any condition.
        </p>
      ...
      <div className="space-y-4">
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-border/50 bg-muted/30 p-5">
            ...
            <p className="text-sm text-muted-foreground">
              The refund request must be raised in writing via email to the official Princeton Professional support team at{" "}
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-border/50 bg-muted/30 p-5">
            ...
            <p className="text-sm text-muted-foreground">
              By enrolling in any course offered by Princeton Professional, candidates acknowledge and agree to comply with
          ...
          <div className="rounded-xl border border-border/50 bg-muted/30 p-5">
            ...
            <p className="text-sm text-muted-foreground">
              Princeton Professional is an independent training and service provider. We are not affiliated, associated,
          ...
          <div className="rounded-xl border border-border/50 bg-muted/30 p-5">
            ...
            <p className="text-sm text-muted-foreground">
              Princeton Professional shall not be held responsible for any financial, personal, or professional loss incurred
        ...
        <section className="relative mb-12 overflow-hidden px-4 text-center sm:mb-20">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
              At Princeton Professional, we strive for transparency in our refund policies. Please review the terms and
              conditions below.
            </p>
          </motion.div>
        </section>
