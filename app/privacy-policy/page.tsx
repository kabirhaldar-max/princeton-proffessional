      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          {[
            ...
            "Only authorized Princeton Professional personnel have access to user data.",
        ...
        <section className="relative mb-12 overflow-hidden px-4 text-center sm:mb-20">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
              At Princeton Professional, we are committed to protecting your privacy and ensuring the security of your
          ...
          <div className="grid gap-12">
            ...
            >
              ...
              <p className="mx-auto mb-6 max-w-2xl text-muted-foreground">
                ...
                Princeton Professional is not responsible for the privacy practices or content of these external sites.
              </p>
